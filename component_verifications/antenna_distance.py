...
file_names = ["ATIS_99999_202501010001_128565kHz", "ATIS_99999_202501010002_128565kHz", "ATIS_99999_202501010003_128565kHz"]
labels = ["160 cm", "220 cm", "280 cm"]
...
ax_1.set_title('Extracted noise for different antenna distances')
ax_1.grid()
ax_1.legend()
fig_1.tight_layout()
fig_1.savefig(PLOT_LOC + "antenna_distance_noise.png")

# Makeup of SNR plot
ax_2.set_xlim(snr_data[0,0], snr_data[-1,0])
ax_2.set_xlabel('Time [s]')
ax_2.set_ylabel('Signal-to-noise ratio [dB]')
ax_2.set_title('Extracted SNR for different antenna distances')
ax_2.grid()
ax_2.legend()
fig_2.tight_layout()
fig_2.savefig(PLOT_LOC + "antenna_distance_snr.png")